        ...
        <div class="info-header" style="background-image:url('<?php _e($this->options->siteUrl().date('Ymd').'.jpg'); ?>');">
            <span class="info-header-img">
                <a href="<?php $this->options->adminUrl(); ?>" target="_blank">
                    <img src="<?php $this->options->themeUrl('img/header.jpeg'); ?>">
                </a>
            </span>
        </div>
        <div class="follow-me">
            <a href="http://music.163.com/#/user/home?id=112872707" target="_blank">Music</a>
            <a href="https://github.com/leeziiAtCn" target="_blank">Github</a>
        </div>
    </section>
